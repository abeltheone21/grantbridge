...
export default function Home() {
  ...
  function getGrantImageUrl(image: any): string {
    ...
    if (image.filename) {
      return `${payloadUrl}/api/media/file/${encodeURIComponent(image.filename)}`;
    }
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#12150F]">
      ...
      <section className="relative min-h-screen flex items-center">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#C6A15B]/10 backdrop-blur-sm border border-[#C6A15B]/20 rounded-full text-[#C6A15B] text-sm mb-6"
              >
                <span className="w-2 h-2 bg-[#C6A15B] rounded-full animate-pulse" />
              ...
              <motion.p
                ...
                className="mt-6 text-base sm:text-lg lg:text-xl text-[#A6A99F] max-w-2xl mx-auto lg:mx-0 leading-relaxed drop-shadow"
              >
                Discover and apply for grants across Africa. Empower your organization 
                with funding opportunities that create lasting impact.
              </motion.p>
              ...
              >
                <button
                  ...
                  className="group px-8 py-4 bg-[#C6A15B] text-[#12150F] rounded-xl hover:bg-[#d4b46d] transition-all font-bold text-lg shadow-lg shadow-[#C6A15B]/20 hover:shadow-xl hover:shadow-[#C6A15B]/30 inline-flex items-center justify-center gap-2"
                >
                  Get Started
                ...
                <Link
                  href="/grants"
                  className="px-8 py-4 bg-[#1C2117] backdrop-blur-sm border border-[#C6A15B]/20 text-[#C6A15B] rounded-xl hover:bg-[#242A1D] hover:border-[#C6A15B]/40 transition-all font-semibold text-lg text-center"
                >
                  Explore Grants
                </Link>
              </motion.div>
              ...
              <motion.div
                ...
                className="mt-8 flex flex-wrap items-center gap-4 sm:gap-6 text-[#A6A99F] text-sm justify-center lg:justify-start"
              >
        ...
        >
          <motion.div
            ...
            className="w-6 h-10 border-2 border-[#C6A15B]/40 rounded-full flex items-start justify-center p-2"
          >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#12150F]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-[#E7E4D8] mb-4">
              About GrantBridge
            </h2>
            <p className="text-[#A6A99F] max-w-2xl mx-auto text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: "Our Mission", desc: "Make funding accessible to every organization across Africa." },
              { title: "Our Vision", desc: "Empower African innovation through seamless funding access." },
              { title: "Our Impact", desc: "Connecting projects with global support and funding opportunities." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                whileHover={{ y: -6 }}
                className="group bg-[#1C2117] rounded-2xl p-8 border border-[#4E5B2A]/20 hover:border-[#C6A15B]/30 hover:bg-[#242A1D] transition-all duration-300"
              >
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#12150F]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#A6A99F] max-w-2xl mx-auto">
                Explore our latest funding opportunities for African organizations
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      {grant.location && (
                        <span className="px-2 py-1 bg-[#3F4F24]/20 text-[#A6A99F] text-xs rounded-full border border-[#4E5B2A]/30">
                          {grant.location.split('(')[0].trim()}
                        </span>
                      )}
                    </div>
                    
                    {grant.deadline && (
                      <p className="text-xs text-[#6C6F66]">
            ...
            <div className="text-center">
              <Link
                href="/grants"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#C6A15B] text-[#12150F] rounded-xl hover:bg-[#d4b46d] transition-all font-bold text-lg shadow-lg shadow-[#C6A15B]/20 hover:shadow-xl hover:shadow-[#C6A15B]/30"
              >
                View More Grants
                <FaArrowRight />
              </Link>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#3F4F24] to-[#1C2117]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h3 className="text-2xl sm:text-3xl font-bold text-[#E7E4D8] mb-10">
            Built for <span className="text-[#C6A15B]">Impact</span>
          </h3>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: "New Platform", desc: "Fresh & Modern" },
              { title: "Curated Grants", desc: "Carefully Selected" },
              { title: "100% Free", desc: "No Hidden Costs" },
              { title: "Pan-African", desc: "Growing Coverage" },
            ].map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="text-center p-6 bg-[#1C2117]/50 backdrop-blur-sm rounded-2xl border border-[#4E5B2A]/20 hover:border-[#C6A15B]/30 hover:bg-[#242A1D] transition-all group"
              >
      ...
      <AnimatedSection className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#12150F]">
        <div className="text-center mb-12">
          ...
          <p className="text-[#A6A99F] max-w-2xl mx-auto">
            Everything you need to find and secure funding for your organization
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {services.map((service, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1, duration: 0.4 }}
              whileHover={{ y: -6, boxShadow: "0 24px 48px rgba(198, 161, 91, 0.06)" }}
              className="group bg-[#1C2117] rounded-2xl p-6 sm:p-8 border border-[#4E5B2A]/20 hover:border-[#C6A15B]/30 hover:bg-[#242A1D] transition-all duration-300"
            >
          ...
          {steps.map((item, i) => (
            ...
            >
              <div className="bg-[#1C2117] rounded-2xl p-6 text-center border border-[#4E5B2A]/20 hover:border-[#C6A15B]/30 hover:bg-[#242A1D] transition-all duration-300">
                <div className="text-5xl font-bold text-[#3F4F24]/30 mb-4 group-hover:text-[#3F4F24]/50 transition-colors">
                  {item.step}
                </div>
                <h3 className="text-lg font-bold text-[#E7E4D8] mb-2">{item.title}</h3>
              ...
              {i < 3 && (
                <div className="hidden lg:block absolute top-1/2 -right-3 text-2xl text-[#C6A15B]/20">
                  →
                </div>
              )}
            </motion.div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#3F4F24] to-[#1C2117]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-[#A6A99F] text-lg mb-8">
              Join organizations already using GrantBridge to secure funding.
            </p>
            <button
              onClick={() => setIsLoginModalOpen(true)}
              className="px-8 py-4 bg-[#C6A15B] text-[#12150F] rounded-xl hover:bg-[#d4b46d] transition-all font-bold text-lg shadow-xl hover:shadow-2xl inline-flex items-center gap-2"
            >
              Get Started Free
              <FaArrowRight />
            </button>
