...
export const metadata = {
   title: 'Privacy Policy | Har Grant Plus',
  description: 'How Har Grant Plus collects, uses, and protects your data.',
};
    ...
    <div className="min-h-screen bg-[#F7FAFC] text-[#1A202C] selection:bg-[#88914C] selection:text-[#FFFFFF]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-6xl h-full pointer-events-none opacity-20">
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[#88914C] blur-[120px]" />
          <div className="absolute bottom-[10%] right-[-10%] w-[30%] h-[30%] rounded-full bg-[#88914C] blur-[100px]" />
        </div>

        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
              Privacy <span className="text-[#88914C]">Policy</span>
            </h1>
            ...
            <div className="lg:col-span-8 max-w-none prose prose-invert prose-headings:text-[#1A202C] prose-p:text-[#4A5568] prose-li:text-[#4A5568] prose-strong:text-[#88914C]">
              <div id="introduction" className="mb-16 scroll-mt-32">
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                  <span className="text-[#88914C]">01.</span> Introduction
                </h2>
                <p>
              ...
              <div id="data-collection" className="mb-16 scroll-mt-32">
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                  <span className="text-[#88914C]">02.</span> Data Collection
                </h2>
              ...
              <div id="usage" className="mb-16 scroll-mt-32">
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                  <span className="text-[#88914C]">03.</span> How We Use Data
                </h2>
              ...
              <div id="security" className="mb-16 scroll-mt-32">
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                  <span className="text-[#88914C]">04.</span> Security Measures
                </h2>
                <p>
                  The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
                </p>
                <div className="bg-[#FFFFFF] border border-[#E5E5E5]/30 p-6 rounded-2xl mt-6">
              ...
              <div id="contact" className="scroll-mt-32">
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                  <span className="text-[#88914C]">05.</span> Contact Us
                </h2>
                <p>
                ...
                <ul className="list-none p-0 space-y-2 mt-4">
                  <li className="flex items-center gap-3">
                    <span className="text-[#88914C]">Email:</span> 
                    <a href="mailto:privacy@grantbridge.com" className="hover:underline text-[#1A202C]">privacy@grantbridge.com</a>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-[#88914C]">Address:</span> 
      ...
      <section className="py-20 border-t border-[#E5E5E5]/20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-[#4A5568] mb-8">Our support team is here to help you understand your rights.</p>
          <a 
