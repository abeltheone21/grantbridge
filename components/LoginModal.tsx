        ...
        <div className="relative bg-[#FFFFFF]/90 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/40 border border-[#E5E5E5]/30 p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 bg-[#FFFFFF] border border-[#38411C] text-[#1A202C] rounded-xl hover:bg-[#F7FAFC] transition-all text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-50"
            >
